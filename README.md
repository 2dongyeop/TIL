...
## 분류
- ## 회고록
    - [ep 13. 주니어 백엔드의 90일 성장기: 불안정에서 안정으로](https://velog.io/@dongvelop/ep-13)
...
- ## Java
    ...
    - [Jigsaw - Modular Java Application Packaging](https://www.notion.so/leedongyeop/0380e065399c49f98c221324d65e7f0b?pvs=4)
    - [멀티스레드 환경을 지원하는 동시성 컬렉션 소개](https://velog.io/@dongvelop/thread-safe-collection)
    ...
    - ### Modern Java in Action
        ...
        - [chapter 7. 병렬 데이터 처리와 성능](https://leedongyeop.notion.site/chapter-7-3426716fcee34f9782a0a2c7f720320f)
...
- ## OS
    - [Linux 서버 성능 및 상태 체크 명령어](https://velog.io/@dongvelop/Linux-OS-status-check)
...
- ## Design-pattern
  ...
  - [Strategy pattern](https://leedongyeop.notion.site/6cbfdeea635245c18aea8b7e92e94447)
  - [Observer pattern](https://leedongyeop.notion.site/6daa3860b3a54fa2aae5df1f8d6c9b14?pvs=4)
  - [Decorator pattern](https://leedongyeop.notion.site/2ad5b9e6f3fe47b9af0076277a54bfd4?pvs=4)
...
- ## Software Architecture
    ...
    - ### 원티드 주관 프리온보딩 백엔드 챌린지 7월
        ...
        - [*Week 2-1 : 사용자 수에 따른 규모를 확장하는 방법 2편*](https://www.notion.so/leedongyeop/Week-2-1-2-aa964d40b6074bed91a0bf6cb054efa2?pvs=4)
        - [*Week 2-2 : 알림 시스템 & 구글 드라이브 설계하기*](https://www.notion.so/leedongyeop/Week-2-2-c26d8a1e71724a848856f242a98da922?pvs=4)
