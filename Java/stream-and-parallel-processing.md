...
> [1절. 스트림 소개](#🔥-1-스트림-소개)
>
> [2절. 스트림의 종류](#🔥-2-스트림의-종류)
> 
> [3절. 스트림 파이프라인](#🔥-3-스트림-파이프라인)
> 
> [4절. 필터링(distinct(), filter())](#🔥-4-필터링)
>
> [5절. 매핑(flatMapXXX(), mapXXX(), asXXXStream(), boxed())](#🔥-5-매핑)
>
> [6절. 정렬(sorted())](#🔥-6-정렬)
>
> [7절. 루핑(peek(), forEach())](#🔥-7-루핑)
>
> [8절. 매칭(allMatch(), anyMatch(), noneMatch())](#🔥-8-매칭)
>
> [9절. 기본 집계(sum(), count(), average(), max(), min())](#🔥-9-기본-집계)
>
> [10절. 커스텀 집계(reduce())](#🔥-10-커스텀-집계)
>
> [11절. 수집(collect())](#🔥-11절-수집)
>
> [12절. 병렬 처리](#🔥-12-병렬-처리)
